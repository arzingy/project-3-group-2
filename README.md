...
- **Interactive Elements**: The project includes:
  ...
  - Three unique data views: shipwrecks, hazardous zones, and density hotspots.
- **Error-Free Deployment**: The interactive map runs seamlessly without errors.
- **Libraries**: Utilized Python's GeoJSON library, which was not covered in class.
